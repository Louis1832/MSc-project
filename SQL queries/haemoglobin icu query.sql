WITH haemoglobin_records AS (
SELECT ce.subject_id, ce.charttime, ce.hadm_id, icu.stay_id, ce.valuenum AS haemoglobin, icu.intime, icu.outtime, icu.los,
