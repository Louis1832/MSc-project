...
%\begin{longtable}{ |L{2cm} | L{1cm} | L{2.5cm} | L{2.5cm} | L{4cm} | L{2cm} |} 
   % \caption{Caption}\label{tab:my_label}\\
    %\hline
    %\textbf{Author} & \textbf{Year} & \textbf{Prediction Model} & \textbf{Best Model} & \textbf{Predictor Variables} & \textbf{Data Source} \\ 
